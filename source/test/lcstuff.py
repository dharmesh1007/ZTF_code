...
class LasairStuff:
    ...
    # Display light curve
    def display_lightcurve(self, y='dc_mag', limit=22, dropnull=True, dropdup=True, errorCol=None):     
        ...
        fig = self.px.scatter(df, x='jd', y=y, error_y=errorCol, width=1000, height=250, color='fid',
            color_discrete_sequence=["green", "red"], opacity=0.5,
